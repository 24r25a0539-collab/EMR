  ...
  return (
    <div className="space-y-8 pb-24 text-white max-w-5xl mx-auto antialiased">
      ...
      <ScrollReveal direction="left">
        <div className="bg-gradient-to-r from-[#0B0B0D] via-[#0D1520] to-[#0B0B0D] text-white p-8 sm:p-10 rounded-[32px] shadow-2xl border border-teal-500/20 flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
