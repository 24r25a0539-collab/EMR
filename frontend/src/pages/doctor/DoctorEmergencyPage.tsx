  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8 pb-24 text-white antialiased">
      ...
      <ScrollReveal direction="left">
        <div className="p-5 sm:p-8 lg:p-10 rounded-[32px] bg-gradient-to-r from-[#1A0A0E] via-[#0E0608] to-[#050506] border border-rose-500/30 text-white shadow-2xl relative overflow-hidden">
